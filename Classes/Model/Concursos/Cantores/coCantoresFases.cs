       ...
       /// <returns></returns>
        ...
        public bool SelectCantoresCategoriasConcurso(out DataTable dtDados)
        {
            string strComando = @"SELECT '" + KuraFrameWork.csConstantes.sTpCarregado + "' as " + caCantoresFases.CC_Controle + "," +
                                 ...
                                 "       CF.cdCategoria, CF.cdTpStatus, CF.nuNotaFinal, CF.pcDesconto " +
                                 "  FROM CANTORESFASES CF " +
        ...
        /// <summary>
        /// Seleciona o cantor no concurso pelo número
        /// </summary>
        /// <param name="dtDados"></param>
        /// <returns></returns>
        public bool SelectCantoresConcursoPorNumero(out DataTable dtDados)
        {
